...
## Needs
Working with the designer, we addressed thier needs for customizations for WordPress which included an Instagram type experience, including a rating engine highlighting their photographic layouts and sharing function. OF course, they wanted this built in a way that they could just upload their content on their own, and work beautifully everytime.

## Responsibilities
I was brought on as a consultant. I was given the comps and specs to build the project from a WordPress starter theme. I used the Genesis platform, PHP, HTML, CSS and JavaScript to complete this project.
