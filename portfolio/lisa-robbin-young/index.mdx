...
* Complete re-branding. Site needed to showcase her new singing career as well as her business coaching.
* Cohesive Look and feel stemming from newly designed logo.
* Easy to update on her own.
* Feature her favorite photos.
* Easy landing page template to sell her products and to collect leads.
* A way to keep track and display events.

### Requirements
* New Site Design
* Feature: Email list collection
* Feature: Blog
* Special Template: Landing page template for special info products and classes.
* Feature: Calendar for showcasing events.
* Mobile Responsive
