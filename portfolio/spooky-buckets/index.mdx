...
date: 10-16-2022
excerpt: "Spooky Buckets - Halloween Fun mixed with my childhood nostaligia."
thumbnail : "./thumb.png"
thumbnail_alt: "Spooky Buckets by Megan Burleson"
tags: ["Graphic Design", "Side Quests", "Digital Illustration", "Game Development"]
---
...
import spookyCard from "./BurlesonCard.mp4"
...
<section className={portfolioStyles.spookyGame}>
<p>Using this artwork - I made an animated card to send out to my friends and family!</p>
<section className={portfolioStyles.video}>
<video controls><source src={spookyCard} type="video/mp4"/></video>
</section>
</section>
